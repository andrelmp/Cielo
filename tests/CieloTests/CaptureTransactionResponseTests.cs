...
namespace CieloTests
{
    ...
    public class CaptureTransactionResponseTests
    {
        ...
        [Test]
        public void GivenAResponseXml_ShouldGetStatusEqualToSucess()
        {
            var checkTransactionResponse = new CaptureTransactionResponse(XmlResponse);
            checkTransactionResponse.Status.Should().Be(Status.Success);
        }
    }
}